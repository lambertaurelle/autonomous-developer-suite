...
> [!NOTE]
> For **Antigravity CLI (`agy`)** compatibility, this constitution is mirrored in [GEMINI.md](file:///home/oph/Documents/antigravity/goofy-chandrasekhar/GEMINI.md), which is automatically loaded by the `agy` runtime.
